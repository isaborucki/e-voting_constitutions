...
# RECODE into dummy
# qb3 "And if you live or were to live in an EU country other than your country of 
#origin, which of the following would be your preferred way of voting in the national 
#elections of your country?"
...
The test says us that working with the Logreg model, so the dummy variable on evoting, 
is a better fit, than the model on technical awareness and ability. Thus, we further 
work with this DV and add techmean variable as IV in 2002, and keep the tech variable as IV also in the two other waves. 
